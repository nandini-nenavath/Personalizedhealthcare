...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv("B:\panace.ai\disease_pred\dataset\Training.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv("B:\panace.ai\disease_pred\dataset\Testing.csv")
       ...
       dis=l[0]
        ...
        for ele in s:
            if (l.count(ele)==2):
                ...
                t1.insert(END,ele)
                dis=ele
    with open('B:\panace.ai\disease_pred\dataset\disdrug.csv') as f:
        r=csv.reader(f)
        for rr in r:
            if(rr[0]==dis):
                if(age=='kids'):
...
#bg=ImageTk.PhotoImage(file="C:/Users/Dell/OneDrive/Desktop/my_details/panace.ai/disease_pred/dataset/img.jpg")
Name = StringVar()
#nkjwehf
'''
def on_resize(event):
...
bgimg = Image.open('C:/Users/Dell/OneDrive/Desktop/my_details/panace.ai/disease_pred/dataset/img1.jpg') # load the background image
li = Label(root)
...
bgimg = Image.open('B:\panace.ai\disease_pred\dataset\img.jpg') # load the background image
li = Label(root)
li.place(x=0, y=0, relwidth=1, relheight=1) # make label l to fit the parent window always
li.bind('<Configure>', on_resize) # on_resize will be executed whenever label l is resized5
...
# labels
NameLb = customtkinter.CTkLabel(master=root, text="Name of the Patient", fg_color="#0eaffd",bg_color="#0eaffd")

NameLb.grid(row=6, column=0, pady=15, sticky=W)


S1Lb = Label(root, text="Symptoms", fg="yellow", bg="black")
S1Lb.grid(row=7, column=0, pady=10, sticky=W)
cat = Label(root, text="select a category ", fg="white", bg="red")
...
res = Label(root, text="Final Predicted Disease", fg="white", bg="red")
res.grid(row=15, column=0, pady=10,sticky=W)
dru = Label(root, text="Final Predicted Drug", fg="white", bg="red")
...
'''ll[0]=StringVar()
ll[0].set(None)
bb=Button(root,text="add symptoms",command=addd)
